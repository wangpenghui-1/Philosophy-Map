...
const justiceNodes: JourneyNode[] = [
  ...
  journeyNode("mills-racial-contract", "charles-w-mills", "第七站 · 纽约", "理想规则可能遮住现实支配", "社会契约的普遍语言曾与种族排除同时存在；正义理论必须把真实的支配结构放回视野。", "种族契约揭示白人优势如何进入制度和知识规范。纠正不义不只是制定中立规则，也包括识别谁长期被规则当作例外。", "面对统一规则，除了问是否一样，也问它在怎样的历史起点上作用于谁。", 11_000, evidence("rawls-charles-w-mills", "对理想理论的非理想批判")),
];
...
const existentialismNodes: JourneyNode[] = [
  ...
  journeyNode("beauvoir-ambiguity", "beauvoir", "第五站 · 巴黎", "自由必须承认模糊处境", "我们既是能够超越现状的主体，也是受身体、历史和他人限制的存在；自由永远带着这种模糊性。", "波伏娃把存在主义从孤立选择推进到处境伦理。压迫会系统性缩小某些人的可能，自己的自由也需要他人的自由得到实现。", "如果殖民权力进入身体经验和自我形象，成为自己还需要怎样的解放？", 11_000, evidence("sartre-beauvoir", "共同论辩中的两条独立道路")),

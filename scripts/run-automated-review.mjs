...
stages.push(await run("npm", ["run", "content:release:check"], "Current release integrity"));
stages.push(await run("npm", ["run", "content:media:check"], "Current media integrity"));
...
stages.push(await run("npm", ["run", "security:audit"], "Production dependency audit"));
stages.push(await run("npm", ["run", "db:migrate:check"], "Migration journal consistency"));
